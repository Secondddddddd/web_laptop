...
@section('content')
    <div class="container mx-auto p-4">
        <h2 class="text-3xl font-semibold mb-4">Danh sách Phụ kiện</h2>

        <!-- Thanh tìm kiếm -->
        <form method="GET" action="{{ route('accessories') }}" class="mb-4 flex">
            <input type="text" name="search" placeholder="Tìm kiếm phụ kiện..."
