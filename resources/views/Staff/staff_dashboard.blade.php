...
<head>
    ...
    @vite(['resources/js/staff_dashboard.js'])
...
<div class="container flex h-screen w-screen">
    ...
    <div class="w-1/4 bg-black-200">
        ...
        <div class="border-b-2 flex items-center space-x-2 p-2">
            <img src="{{asset('avatar/'.$user->avatar)}}" alt="Web logo" class="w-12 h-12 rounded-full border-2 border-black">
            <p class="text-lg font-semibold text-gray-500 ">{{$user->full_name}}</p>
        </div>
        <div class="mt-5">
