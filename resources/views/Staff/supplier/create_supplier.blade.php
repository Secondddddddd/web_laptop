...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-5">
        ...
        <form action="{{ route('staff_supplier_store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-between">
                <a href="{{ route('staff_supplier_list') }}" class="bg-gray-500 text-white px-4 py-2 rounded">Quay lại</a>
